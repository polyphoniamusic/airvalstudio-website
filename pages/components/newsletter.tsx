  ...
  return (
    <>
      ...
      <div className="newsletter-terms-block">
          ...
          {showTerms && 
              <p className="newsletter-prevent-text">By submitting your information, you agree to receive updates and marketing messages about blurblur. You understand that you can opt-out at any time by emailing <span><a className="newsletter-prevent-email" href="mailto:contact@blurblurmusic.com">contact@blurblurmusic.com</a></span>.</p>
          }
      </div>
